...
export const CITY_COORDINATES = [
    ...
    { city: 'Vizag', aliases: ['Visakhapatnam', 'Waltair'], lat: 17.6868, lng: 83.2185, isPrimaryHub: false },
    { city: 'Bhubaneswar', aliases: ['Bhubaneshwar'], lat: 20.2961, lng: 85.8245, isPrimaryHub: false },
