...
import { ArrowLeft, Save, Users, Globe, Settings, Bell, Shield, Sparkles, Zap, Heart, Instagram, Linkedin, Mail, Phone, MapPin, FileText, ChevronDown, ChevronUp, Target } from 'lucide-react';
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 pt-32">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-16 gap-8">
                    <div className="space-y-2">
                        <Link to="/admin" className="inline-flex items-center gap-2 text-gray-500 hover:text-white transition-colors uppercase text-[10px] font-black tracking-widest mb-4 group">
