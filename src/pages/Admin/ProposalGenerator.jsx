                            ...
                            {paginatedPages.map((pageItems, pageIdx) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        {formData.showFooter && (
                                            <footer
                                                className="absolute bottom-6 left-10 right-10 h-10 flex items-center justify-between px-10 rounded-full border border-black/10 shadow-lg z-50 bg-[#39FF14]/40"
                                                style={{
