            ...
            try {
                ...
                if (!skipPdf) {
                    ...
                    if (pdf) {
                        ...
                        // Enforce < 500KB check warning if needed, but JPEG should be safe
                        ...
                        if (!proceed) throw new Error("User cancelled because PDF failed.");
                    }
                } else {
                ...
                const cleanItems = items.map(item => {
                    ...
                    return {
                        ...
                        qty: Number(item.qty) || 0, // Fix: mapped from 'quantity' in state
