...
const getGridTemplate = () => {
    ...
    // Remaining 20% divided by custom columns?
    // Let's go with fractions.
    // Desc: 3fr, Qty: 0.8fr, Price: 1.2fr, Total: 1.2fr -> Base
    // Custom: 1.5fr each
                    ...
                    >
                        ...
                        <div className="p-12 pb-8 flex justify-between items-start">
                            <div className="flex items-start gap-4">
                                <img src="/logo.png" crossOrigin="anonymous" alt="NewBi Logo" className="w-20 h-20 object-contain" />
                                <div>
                            ...
                            <div className="text-right">
                                ...
                                <p className="text-sm font-bold uppercase text-gray-700">CLIENT: {formData.clientName || '_______________'}</p>
                            </div>
                        </div>
