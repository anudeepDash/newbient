        ...
        return (
            <div className="min-h-screen flex items-center justify-center text-white">
                <div className="text-center">
                    ...
                    <p className="text-gray-400 mt-2">Only Developer Admins can access these settings.</p>
    ...
    return (
        <div className="min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
                    ...
                    <Card className={`p-8 border-2 transition-all duration-500 ${maintenanceState.global ? 'border-red-500 bg-red-500/5 shadow-[0_0_30px_rgba(239,68,68,0.2)]' : 'border-neon-green/30 bg-neon-green/5'}`}>
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-2xl font-black text-white uppercase tracking-tighter">Main Character Mode</h2>
                                    <p className="text-gray-400 text-sm">Killswitch for the entire website. Everyone gets redirected to maintenance page.</p>
                                </div>
                            </div>
                            <Button
                                onClick={toggleGlobalMaintenance}
                                variant={maintenanceState.global ? 'danger' : 'primary'}
                                className={`px-12 py-6 text-lg font-black italic tracking-widest ${maintenanceState.global ? 'animate-pulse' : ''}`}
                            >
                ...
                {/* Info Text */}
                <p className="mt-12 text-center text-xs text-gray-600 uppercase tracking-widest">
                    ⚠️ Toggles are live. Changes affect the website in real-time. FR FR.
                </p>
            </div>
        </div>
    );
