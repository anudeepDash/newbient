        ...
        >
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <div className="lg:col-span-4">
                        <Card className="p-10 bg-gray-100 dark:bg-zinc-900/40 backdrop-blur-3xl border-black/10 dark:border-white/5 rounded-[2.5rem] lg:sticky lg:top-32">
                            <h2 className="text-2xl font-black font-heading uppercase italic tracking-tight text-gray-900 dark:text-white mb-8 flex items-center gap-3">
                            ...
                            <div className="space-y-8">
                                <div className="space-y-3">
                                    ...
                                    <div className="relative group">
                                        ...
                                        />
                                        <div className={cn(
                                            "h-32 border-2 border-dashed border-black/10 dark:border-white/5 rounded-2xl flex flex-col items-center justify-center gap-3 bg-white dark:bg-black/30 group-hover:border-neon-blue/40 transition-all",
                                ...
                                <form onSubmit={handleAdd} className="space-y-6">
                                    <div className="space-y-3">
                                        <Input
                                            ...
                                            required
                                            disabled={uploading}
                                            className="h-14 bg-white dark:bg-black/50 border-black/10 dark:border-white/5 rounded-xl text-[10px] font-black uppercase tracking-widest focus:border-neon-blue/30"
                                        />
                                    </div>
                                    <div className="space-y-3">
                        ...
                        <div className="flex sm:grid sm:grid-cols-2 gap-6 sm:gap-8 overflow-x-auto sm:overflow-visible pb-8 sm:pb-0 scrollbar-hide snap-x snap-mandatory -mx-6 px-6 sm:mx-0 sm:px-0">
                            ...
                            {galleryImages.map((item, index) => (
                                <motion.div 
                                    ...
                                    className="min-w-[85vw] sm:min-w-0 snap-center shrink-0 group relative aspect-video bg-gray-100 dark:bg-zinc-900 border border-black/10 dark:border-white/5 rounded-[2rem] overflow-hidden hover:border-neon-blue/30 transition-all duration-500"
                                >
                                    ...
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-transparent to-transparent p-8 flex flex-col justify-end">
                                        <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                                            ...
                                            <h3 className="text-lg font-black font-heading text-gray-900 dark:text-white uppercase italic tracking-tight truncate">{item.title || 'ARCHIVE_DATA'}</h3>
                                        </div>
                                    </div>
                                    <button
                                        onClick={() => deleteGalleryImage(item.id)}
                                        className="absolute top-6 right-6 w-10 h-10 bg-red-500/10 text-red-500 border border-red-500/20 rounded-xl flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all hover:bg-red-500 hover:text-gray-900 dark:hover:text-white"
                                    >
                                        <Trash2 size={16} />
                                    </button>
                                </motion.div>
                            ...
                            {galleryImages.length === 0 && (
                                <div className="col-span-full py-40 flex flex-col items-center justify-center gap-6 bg-gray-100 dark:bg-zinc-900/20 rounded-[3rem] border-2 border-dashed border-black/10 dark:border-white/5">
