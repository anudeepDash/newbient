                        ...
                        <div className="flex flex-col md:flex-row justify-between items-start mb-12 border-b border-white/10 pb-8 print:border-gray-300 gap-8">
                            <div className="flex flex-col">
                                <div className="flex items-center gap-3 mb-4">
                                    <img src="/logo.png" alt="Newbi" className="h-12 w-auto" onError={(e) => e.target.style.display = 'none'} />
                                    {/* Fallback text if logo missing */}
                                    <h2 className="text-2xl font-bold text-white print:text-black">Newbi Entertainments</h2>
                                </div>
                                <div className="text-gray-400 text-sm print:text-gray-600 space-y-1">
                            ...
                            <div className="text-left md:text-right">
                                ...
                                <div className="space-y-1">
                                    <div className="flex justify-between md:justify-end gap-4">
                                        ...
                                        <span className="text-white font-mono print:text-black">{new Date().toLocaleDateString()}</span>
                                    </div>
                                    <div className="flex justify-between md:justify-end gap-4">
                                        <span className="text-gray-500 font-semibold uppercase text-xs tracking-wider">Due Date:</span>
