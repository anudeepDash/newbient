...
const Layout = () => {
    ...
    const isSpecialPage = 
        ...
        location.pathname === '/creator/' ||
        location.pathname.startsWith('/creator/join') ||
    ...
    return (
        <div className={cn(
            "flex flex-col bg-gray-50 dark:bg-black text-gray-900 dark:text-white selection:bg-neon-pink selection:text-black w-full max-w-[100vw] overflow-x-hidden transition-colors duration-300",
            ...
            <div className="fixed top-0 left-0 w-full h-full overflow-hidden -z-10 pointer-events-none transition-opacity duration-500 opacity-0 dark:opacity-100">
