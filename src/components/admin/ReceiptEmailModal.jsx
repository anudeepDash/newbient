        ...
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
            ...
            >
                <Card className="bg-gray-100 dark:bg-zinc-950 border-black/10 dark:border-white/10 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.8)] overflow-hidden">
                    ...
                    <div className="flex items-center justify-between p-6 md:p-8 border-b border-black/10 dark:border-white/5">
                        <div className="flex items-center gap-4 max-w-[calc(100%-48px)]">
                            ...
                            <div className="min-w-0">
                                <h2 className="text-xl md:text-2xl font-black font-heading tracking-tighter uppercase italic text-gray-900 dark:text-white truncate">
                        ...
                        <button
                            onClick={onClose}
                            className="w-10 h-10 rounded-full bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 flex items-center justify-center hover:bg-white hover:text-black transition-all text-gray-600 dark:text-gray-400 shrink-0"
                        >
                            <X size={18} />
                        </button>
                    </div>
                    ...
                    {/* Mobile Tab Bar */}
                    <div className="lg:hidden flex border-b border-black/10 dark:border-white/5 bg-gray-100 dark:bg-zinc-950/60 backdrop-blur-2xl shrink-0">
                        <button
                            type="button"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 max-h-[calc(90vh-120px)] overflow-hidden">
                        {/* LEFT: Composer */}
                        <div className={cn(
                            "p-6 md:p-8 overflow-y-auto max-h-[calc(90vh-180px)] lg:max-h-[calc(90vh-120px)] border-r border-black/10 dark:border-white/5 custom-scrollbar",
                            ...
                            <form onSubmit={handleSend} className="space-y-6">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <Input
                                        ...
                                        className="h-14 bg-white dark:bg-black/50 border-black/10 dark:border-white/5 rounded-2xl text-sm font-bold focus:border-neon-green/30"
                                        required
                                    />
                                </div>
                                ...
                                <div className="p-5 rounded-2xl bg-neon-green/5 border border-neon-green/10">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 text-[10px]">
                                        <div>
                                            ...
                                            <p className="text-gray-900 dark:text-white font-black mt-0.5">{receipt?.reference || 'N/A'}</p>
                                        </div>
                                        <div>
                                            <span className="text-gray-500 font-bold uppercase tracking-widest">Amount</span>
                                            <p className="text-gray-900 dark:text-white font-black mt-0.5">₹{defaultAmount}</p>
                                        </div>
                                        <div>
                                            <span className="text-gray-500 font-bold uppercase tracking-widest">Payee</span>
                                            <p className="text-gray-900 dark:text-white font-black mt-0.5 truncate">{receipt?.receiverName || 'N/A'}</p>
                                        </div>
                                        <div>
                        ...
                        {/* RIGHT: Live Preview */}
                        <div className={cn(
                            "bg-gray-100 dark:bg-zinc-900/40 max-h-[calc(90vh-180px)] lg:max-h-[calc(90vh-120px)]",
