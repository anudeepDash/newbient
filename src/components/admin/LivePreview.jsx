                                ...
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent p-6 flex flex-col justify-end">
                                    <div className="flex items-center justify-between mb-3 w-full">
                                        ...
                                        <div className="flex items-center gap-1">
                                            ...
                                            <span className="text-[8px] font-black uppercase tracking-widest text-gray-400">{data.location || 'Mainland India'}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-4 flex items-center gap-2 text-neon-blue text-[10px] font-black uppercase tracking-widest">
                                        {data.buttonText || 'Access Event'} <ArrowRight size={12} />
                                    </div>
                                </div>
                            </div>
                        </div>
