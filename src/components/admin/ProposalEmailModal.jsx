                                ...
                                <div className="p-5 rounded-2xl bg-neon-green/5 border border-neon-green/10">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 text-[10px]">
                                        <div>
                                            ...
                                            <p className="text-gray-900 dark:text-white font-black mt-0.5">{proposal?.proposalNumber || 'N/A'}</p>
                                        </div>
                                        <div>
                                            <span className="text-gray-500 font-bold uppercase tracking-widest">Project</span>
                                            <p className="text-gray-900 dark:text-white font-black mt-0.5 truncate">{proposal?.title || 'N/A'}</p>
                                        </div>
                                        <div>
                                            <span className="text-gray-500 font-bold uppercase tracking-widest">Client</span>
                                            <p className="text-gray-900 dark:text-white font-black mt-0.5 truncate">{proposal?.clientName || 'N/A'}</p>
                                        </div>
                                        <div>
