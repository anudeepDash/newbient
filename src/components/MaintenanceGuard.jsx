                ...
                <div className="relative group cursor-not-allowed">
                    <div className="absolute inset-0 bg-black/60 backdrop-blur-[2px] z-20 flex items-center justify-center rounded-xl border border-dashed border-red-500/50">
                        <div className="text-center p-4">
                            ...
                            <h3 className="text-white font-black italic uppercase tracking-tighter">Lowkey Down</h3>
                            <p className="text-gray-400 text-xs uppercase tracking-widest mt-1">Maintenance FR FR</p>
                        </div>
                    </div>
