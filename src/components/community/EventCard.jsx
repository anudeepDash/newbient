        ...
        >
            ...
            <div className="absolute inset-x-0 bottom-0 z-10 p-8 pt-20 bg-gradient-to-t from-black via-black/80 to-transparent">
                <div className="space-y-4">
                    ...
                    <h3 className="event-title text-2xl md:text-3xl font-extrabold font-heading tracking-tight text-white leading-tight group-hover:translate-x-1 transition-transform duration-500">
                        {item.title}
                    </h3>
                ...
                <div className="mt-6 overflow-hidden h-16 opacity-100 md:h-0 md:opacity-0 md:group-hover:h-16 md:group-hover:opacity-100 transition-all duration-500 ease-out">
                    <button 
                        className="w-full h-16 rounded-xl bg-white text-black font-black uppercase tracking-[0.2em] text-[10px] flex items-center justify-center gap-3 active:scale-95 transition-all shadow-2xl"
                    >
