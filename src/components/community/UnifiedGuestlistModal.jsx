            ...
            {isOpen && (
                <div className="fixed inset-0 z-[100] flex items-end md:items-center justify-center overflow-hidden">
                    ...
                    <AnimatePresence>
                        {isDownloading && (
                            <motion.div 
                                ...
                                animate={{ opacity: 1 }} 
                                exit={{ opacity: 0 }} 
                                className="fixed inset-0 z-[200] bg-white dark:bg-black/80 backdrop-blur-2xl flex flex-col items-center justify-center gap-6"
                            >
                                ...
                                <div className="text-center space-y-2">
                                    ...
                                    <p className="text-[12px] font-black text-gray-900 dark:text-white uppercase italic tracking-tighter">GENERATING YOUR ACCESS PASS...</p>
                                </div>
                            </motion.div>
                        )}
                    </AnimatePresence>
                    ...
                    >
                        ...
                        <div className="relative w-full sm:w-[384px] h-48 sm:h-auto bg-[#0a0a0a] border-b sm:border-b-0 sm:border-r border-black/10 dark:border-white/10 overflow-hidden shrink-0">
                            {guestlist.image ? (
                        ...
                        <div className="flex-1 flex flex-col min-h-0 relative">
                            ...
                            <button 
                                onClick={onClose} 
                                className="hidden sm:flex absolute top-8 right-8 w-12 h-12 rounded-2xl bg-black/5 dark:bg-white/5 border border-black/10 dark:border-white/10 items-center justify-center text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:rotate-90 transition-all duration-500 z-[60]"
                            >
                                <X size={22} />
                            </button>
                                ...
                                <AnimatePresence mode="wait">
                                    {step === 'selection' && (
                                        <motion.div key="selection" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8 sm:space-y-12">
                                            <div>
                                                <h3 className="text-3xl sm:text-4xl font-black font-heading text-gray-900 dark:text-white italic tracking-tighter uppercase leading-[0.9] mb-3">
                                    ...
                                    {step === 'details' && (
                                        <motion.div key="details" initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: -20 }} className="space-y-8 sm:space-y-10">
                                            <div className="flex items-center gap-4">
                                                <button onClick={() => setStep('selection')} className="w-10 h-10 rounded-xl bg-black/5 dark:bg-white/5 flex items-center justify-center text-gray-500 hover:text-gray-900 dark:hover:text-white transition-colors">
                                                    <ChevronLeft size={20} />
                                                </button>
                                                <h3 className="text-3xl sm:text-4xl font-black font-heading text-gray-900 dark:text-white italic tracking-tighter uppercase leading-[0.9]">
                                                ...
                                                {isRSVPOnly ? (
                                                    ...
                                                    <>
                                                        ...
                                                        <div className="w-full flex flex-col gap-2">
                                                            ...
                                                            <div className="grid grid-cols-2 gap-2">
                                                                <Button 
                                                                    ...
                                                                    variant="outline"
                                                                    className="h-12 border-black/10 dark:border-white/10 text-gray-900 dark:text-white font-black uppercase tracking-[0.2em] text-[8px] rounded-xl hover:bg-black/5 dark:hover:bg-white/5 transition-all flex items-center justify-center gap-2"
                                                                >
                                                                ...
                                                                <a 
                                                                    ...
                                                                    className="h-12 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:hover:bg-white/10 border border-black/10 dark:border-white/10 rounded-xl flex items-center justify-center gap-2 text-[8px] font-black uppercase tracking-widest text-gray-900 dark:text-white transition-all"
                                                                >
                                                        ...
                                                        <div className="fixed -left-[2000px] top-0">
                                                            <div id="ticket-download-surface" className="w-[800px] bg-white dark:bg-black p-16 flex flex-col gap-12 font-sans border-2 border-neon-green/20">
                                                                {/* Logo Header */}
                                                                ...
                                                                {/* Event Header */}
                                                                <div className="space-y-4">
                                                                    <h1 className="text-7xl font-black text-gray-900 dark:text-white italic uppercase tracking-tighter leading-tight bg-gradient-to-r from-gray-950 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent">
                                                                        {guestlist.title}
                                                                    </h1>
                                                                    <div className="flex gap-8">
                                                                        <div className="space-y-1">
                                                                            <p className="text-[10px] font-black text-gray-600 uppercase tracking-widest">DATE</p>
                                                                            <p className="text-xl font-bold text-gray-900 dark:text-white uppercase italic">{guestlist.date || 'To Be Announced'}</p>
                                                                        </div>
                                                                        <div className="space-y-1">
                                                                            <p className="text-[10px] font-black text-gray-600 uppercase tracking-widest">LOCATION</p>
                                                                            <p className="text-xl font-bold text-gray-900 dark:text-white uppercase italic">{guestlist.location || 'Special Venue'}</p>
                                                                        </div>
                                                                    </div>
                                                                </div>

                                                                {/* QR and Code */}
                                                                <div className="flex items-center gap-16 p-12 bg-gray-100 dark:bg-zinc-900/50 rounded-3xl border border-black/10 dark:border-white/5">
                                                                ...
                                                                <div className="pt-8 border-t border-black/10 dark:border-white/5 flex items-center justify-between">
                                                                    <p className="text-[9px] font-black text-gray-900 dark:text-white/20 uppercase tracking-[0.3em] italic">NEWBI ENT.</p>
