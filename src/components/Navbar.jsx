        ...
        <>
            ...
            {(pinnedAnnouncement && !(maintenanceState.global && user?.role === 'developer')) && (
                <motion.div 
                    ...
                    className="fixed top-0 left-0 right-0 z-[55] bg-white/60 dark:bg-zinc-950/20 backdrop-blur-2xl border-b border-gray-200 dark:border-white/5 py-4 px-6 text-center shadow-[0_4px_30px_rgba(0,0,0,0.1)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.5)] overflow-hidden group"
                >
                    ...
                    {(() => {
                        ...
                        const content = (
                            <div className="flex items-center justify-center gap-3">
                                ...
                                <p className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-gray-700 dark:text-white/90">
            ...
            {!location.pathname.toLowerCase().includes('/admin/create-') && !location.pathname.toLowerCase().includes('/admin/edit-') && !location.pathname.toLowerCase().includes('/admin/agreements/') && (
                ...
                <header className="w-full h-16 bg-white/70 dark:bg-zinc-950/35 backdrop-blur-3xl border border-black/[0.06] dark:border-white/[0.08] rounded-2xl px-6 md:px-8 flex items-center justify-between shadow-[0_8px_30px_-15px_rgba(0,0,0,0.15)] dark:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] select-none">
                    ...
                    {/* Center: Desktop Menu */}
                    <div className="hidden md:flex items-center gap-1 bg-gray-100/60 dark:bg-black/20 p-1.5 rounded-full border border-black/5 dark:border-white/5">
                        {allLinks.map((link) => {
                            ...
                            return (
                                <Link
                                    ...
                                    className={cn(
                                        'px-4 py-2.5 text-[10px] font-black uppercase tracking-widest transition-all rounded-full relative group flex items-center gap-2',
                                        isActive ? 'text-black' : 'text-gray-500 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white',
                                        isUnderMaintenance && !isClickable && 'opacity-60 cursor-not-allowed grayscale'
                                    )}
                                >
                                    <span className="relative z-10">{link.name}</span>
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        <button
                            onClick={toggleTheme}
                            className="p-2 rounded-xl bg-gray-200/50 dark:bg-white/5 border border-gray-300/50 dark:border-white/10 text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white hover:bg-gray-300/50 dark:hover:bg-white/10 transition-all"
                        ...
                        {user && <div className="h-4 w-px bg-gray-300 dark:bg-white/10 mx-0.5" />}
                        ...
                        {user ? (
                            ...
                            >
                                <div className="flex items-center gap-2">
                                    <div className="w-8 h-8 rounded-full bg-gray-200 dark:bg-zinc-900 border border-gray-300 dark:border-white/10 flex items-center justify-center shrink-0 p-0.5 group-hover/avatar:border-neon-green/50 transition-all shadow-md">
                                        <div className="w-full h-full rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center font-black text-[10px] text-gray-700 dark:text-white group-hover/avatar:text-neon-green">
                                            {user.displayName ? user.displayName.charAt(0) : 'U'}
                                        </div>
                                    </div>
                                    <div className="text-left flex flex-col justify-center hidden md:flex">
                                        <span className="text-[10px] font-bold text-gray-700 dark:text-white leading-none capitalize tracking-tight group-hover/avatar:text-neon-green transition-colors">
