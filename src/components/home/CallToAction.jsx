...
const CallToAction = () => {
    return (
        <section className="py-32 md:py-40 bg-[#020202] relative overflow-hidden flex flex-col items-center justify-center border-t border-white/5" id="contact">
            ...
            <div className="max-w-6xl mx-auto px-6 text-center relative z-10">
                ...
                >
                    <a 
                        ...
                        className="group relative w-full md:w-auto h-16 px-10 flex items-center justify-center bg-white text-black font-black font-heading uppercase tracking-widest text-sm rounded-2xl transition-all duration-300 hover:scale-[1.02] md:hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(255,255,255,0.1)]"
                    >
                    ...
                    <div className="flex w-full md:w-auto gap-4">
                        ...
                        <a 
                            ...
                            target="_blank" 
                            rel="noopener noreferrer"
                            className="flex-1 md:w-16 h-16 rounded-2xl bg-zinc-900 border border-white/10 flex items-center justify-center text-white hover:border-white hover:text-white transition-all duration-300"
                        >
                            <Linkedin size={24} />
                        </a>
                    </div>
